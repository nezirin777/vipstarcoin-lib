# Public Key
Represents a HTMLCOIN public key and is needed to be able to receive HTMLCOIN, as is usually represented as a HTMLCOIN [Address](address.md). 

A PublicKey in htmlcoincore is an immutable object and can be instantiated from a [Point](crypto.md), string, [PrivateKey](privatekey.md), Buffer or a [BN](crypto.md).
...
> var compressedPK = htmlcoincore.PublicKey('030589ee559348bd6a7325994f9c8eff12bd'+
...
> var compressedPK2 = new htmlcoincore.PublicKey('02a1633cafcc01ebfb6d78e39f687a1f'+
...
> var uncompressed = htmlcoincore.PublicKey('0479BE667EF9DCBBAC55A06295CE870B07029'+
